 ...
 */
public class Main2 {
	public static <JMenuActions> void main(String[] args) {
		...
		// 5) Set the "player" init location - should be a valid location
		MyGUI<JMenuActions> mygui= new MyGUI<JMenuActions>();
		MouseEvent init = null;
		mygui.mousePressed(init); 
		play1.setInitLocation(mygui.getX(),mygui.getY());
